...
export async function authRoutes(fastify: FastifyInstance) {
  ...
  // Register new user
  fastify.post<{ Body: RegisterRequest }>('/register', asyncHandler(async (request, reply) => {
  ...
  // Login user
  fastify.post<{ Body: LoginRequest }>('/login', asyncHandler(async (request, reply) => {
  ...
  // Update user profile
  fastify.put<{ Body: Partial<RegisterRequest> }>('/profile', 
  ...
  // Change password
  fastify.post<{ Body: { current_password: string, new_password: string } }>('/change-password',
    { preHandler: authMiddleware },
    asyncHandler(async (request, reply) => {
