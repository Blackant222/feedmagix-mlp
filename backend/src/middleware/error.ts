...
import { ErrorResponse, ValidationError as ApiValidationError } from '../types/api.types.js'
...
export async function requestLogger(request: FastifyRequest, reply: FastifyReply) {
  ...
  // Simple response logging without hooks
...
export function mapAIError(error: any): AppError {
