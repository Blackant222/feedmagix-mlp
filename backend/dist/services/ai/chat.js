...
export class AIChatService {
    sessions = new Map(); // Store chat sessions
...
`;
            ...
            const structuredResponse = await generateStructuredOutput(analysisPrompt, schema, { temperature: 0.6 });
...
export async function getComparisonRecommendation(products, petContext) {
...
`;
    ...
    try {
        const result = await generateStructuredOutput(comparisonPrompt, schema, { temperature: 0.4 });
