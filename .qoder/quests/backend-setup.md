...
This design maintains complete compatibility with the existing frontend application while providing a robust, scalable Fastify backend with the same AI capabilities and database structure as the original implementation.